  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        ...
        body("Le cadre de réalisation de ce projet s'inscrit au sein d'un groupe industriel international d'équipementier automobile (Tier-1) spécialisé dans l'injection thermoplastique et l'assemblage de composants automobiles de haute précision. L'entreprise opère sur plusieurs sites de production stratégiques : les usines de Tunisie (Kondar et Sousse) et l'usine de République Tchèque (Brno - CZ1)."),
        pb(),
        body("L'infrastructure industrielle comprend un parc complet de 108 machines réelles (presses à injecter Demag Systec 50T à 420T, Arburg 50T à 500T, Billion 150T à 320T, Engel vertical, robots de soudure laser Inautec 1 à 7, bancs d'éclatement et de test d'étanchéité Huber Suhner) interconnectées à un Data Warehouse d'entreprise (dbDWH) alimenté par l'ERP Microsoft Dynamics NAV (Navision)."),
        pb(),
        body("Ses activités principales s'articulent autour de :"),
        bullet("La fabrication et l'assemblage de pièces automobiles de haute exigence pour de grands constructeurs mondiaux : Valeo, Bosch, Delphi / Aptiv, Continental, Porsche, Mann+Hummel, Renault / Nissan, Nexteer, YAPP."),
        ...
        body("Afin de mieux cerner l'environnement industriel du projet, nous présentons ci-dessous sa fiche d'identité opérationnelle et technique :"),
        pb(),
        makeTable(
          ["Caractéristique", "Détail de l'entreprise"],
          [
            ["Raison Sociale", "Groupe Industriel Plasturgie & Équipementier Automobile"],
            ["Secteur d'Activité", "Industrie Automobile (Tier-1), Injection Plastique & Assemblage"],
            ["Sites de Production", "Tunisie (Usines de Kondar et Sousse) & République Tchèque (Usine de Brno - CZ1)"],
            ["Principaux Clients", "Valeo, Bosch, Delphi/Aptiv, Continental, Porsche, Mann+Hummel, Renault, Nexteer, YAPP"],
            ["Système d'Information", "ERP Microsoft Dynamics NAV, Data Warehouse (dbDWH), Spring Boot 3, React Metronic 8, FastAPI Python"],
            ["Parc Machines", "108 machines réelles (Demag, Arburg, Billion, Engel, Inautec, Huber Suhner)"],
            ["Volumétrie Données", "Plus de 3 millions de transactions historiques (1.5M ILE, 876k CLE, 814k Stock)"],
          ],
          [3500, 6000]
        ),
        new Paragraph({
        ...
        title3("1.2.4 Organisation Multi-Sites et Ateliers"),
        body("L'organisation industrielle s'articule autour de centres de charge et d'ateliers complémentaires répartis sur les différents sites :"),
        bullet("**Site Tunisie (Kondar & Sousse)** : regroupe les ateliers d'injection thermoplastique lourde (TN1-INJE, TN2-INJ) et les lignes d'assemblage complexes (TN1-ASSE, TN2-ASSE) pour flotteurs de carburant, réservoirs et modules SCR."),
        bullet("**Site République Tchèque (Brno - CZ1)** : dédié aux technologies de soudure laser robotisée (CZA avec Inautec 1..7), au moulage de précision (CZM) et aux lignes de contrôle qualité permanent (CZQ)."),
        bullet("**Département Informatique & Data Science** : assure l'alimentation du Data Warehouse (dbDWH) et l'intégration des modèles prédictifs d'aide à la décision."),
        bullet("**Département Logistique & Supply Chain** : gère les flux physiques, la traçabilité des lots et la valorisation financière des stocks multi-sites."),
        pb(),
