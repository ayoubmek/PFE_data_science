  ...
  sections: [
    ...
    // -------------------------------------------------------------
    {
      ...
      children: [
        ...
        tocLine("Sommaire", 0, "iv"),
        tocLine("Liste des Figures", 0, "v"),
        tocLine("Liste des Tableaux", 0, "vi"),
        tocLine("Liste des Abréviations", 0, "vii"),
        pb(),
        ...
        tocLine("1.4 Solution Proposée", 1, "8"),
        ...
        tocLine("1.6 Langage de Modélisation UML", 1, "15"),
        ...
        tocLine("3.4 Analyse Exploratoire des Données et Diagnostic Qualité", 1, "33"),
        ...
        tocLine("3.5.3 Stratégie d'Agrégation et d'Optimisation des Données Analytiques", 2, "38"),
        tocLine("3.5.4 Bilan Qualité des Données et Performances", 2, "38"),
        tocLine("3.6 Sécurité d'Accès, Gouvernance des Données et Rôles RBAC", 1, "39"),
        ...
        tocLine("3.7 Bilan des Livrables et Validation du Sprint 1", 1, "41"),
        ...
        tocLine("4.4.2 Structuration Standard Prophet", 2, "47"),
        tocLine("4.4.3 Découpage Chronologique Train et Test", 2, "47"),
        ...
        tocLine("4.6.1 Régression Linéaire", 2, "49"),
        tocLine("4.6.2 Modèle Autorégressif ARIMA", 2, "50"),
        tocLine("4.6.3 Modèle Additif Prophet de Meta", 2, "51"),
        tocLine("4.6.4 Détection d'Anomalies par Isolation Forest", 2, "52"),
        ...
        tocLine("4.9 Projections à 30 jours, Analyse des Incertitudes et Fallback", 1, "55"),
        tocLine("4.10 Bilan des Livrables et Validation Data Science du Sprint 2", 1, "56"),
        ...
        tocLine("5.6.1 Calcul des Quantités à Produire et Commander sur 45 Jours", 2, "63"),
        ...
        tocLine("5.6.4 Moteur Prescriptif du Point de Commande", 2, "65"),
        ...
        tocLine("5.7.4 Analyse Multi-Sites et Transferts Inter-Usines", 2, "69"),
        ...
        tocLine("6.4 Conception et Réalisation des Interfaces Utilisateur", 1, "75"),
        ...
        tocLine("Figure 4.2 : Comparaison visuelle des modèles de prévision de production selon R² et MAE", 1, "57"),
        ...
        tocLine("Tableau 2.4 : Bilan des livrables du Sprint 0", 1, "28"),
        ...
        tocLine("Tableau 3.3 : Bilan qualité des données et performances avant et après optimisations", 1, "38"),
        tocLine("Tableau 3.4 : Bilan des livrables et validation du Sprint 1", 1, "42"),
        ...
        tocLine("Tableau 4.7 : Avantages et limites du modèle Prophet", 1, "51"),
        tocLine("Tableau 4.8 : Avantages et limites de l'algorithme Isolation Forest", 1, "52"),
        ...
        tocLine("Tableau 4.11 : Justification multicritère du choix de Prophet", 1, "54"),
        tocLine("Tableau 4.12 : Bilan des livrables et validation Data Science du Sprint 2", 1, "56"),
        tocLine("Tableau 5.1 : Priorisation des tâches du Sprint 3 – Gestion Intelligente des Stocks", 1, "59"),
        tocLine("Tableau 5.2 : Classification des articles par niveau de stock", 1, "62"),
    ...
    // -------------------------------------------------------------
    {
      ...
      children: [
        ...
        conclusionBox("Ce chapitre a exposé le cadre général du projet au sein d'un grand équipementier de plasturgie automobile. L'analyse critique de l'existant a confirmé l'urgence d'une solution unifiée et intelligente pour surmonter le cloisonnement des données. Grâce au cadre méthodologique Scrum et à la modélisation UML, le périmètre du projet est clairement balisé en 20 User Stories. Le chapitre suivant présente les résultats du Sprint 0, consacré à l'analyse détaillée des besoins et à la conception architecturale globale."),
        pageBreak(),
        ...
        bullet("**Volumétrie et passage à l'échelle analytique** : le système doit être capable d'ingérer, d'assainir et d'agréger efficacement les historiques massifs du Data Warehouse (plus de 3,2 millions d'enregistrements) avec un temps de réponse inférieur à la seconde lors des extractions de séries temporelles et des calculs d'agrégats statistiques."),
        bullet("**Précision et conformité métrique des modèles d'IA** : les algorithmes prédictifs de séries temporelles doivent garantir une erreur relative moyenne (MAPE) strictement inférieure au seuil industriel de 5 % et un coefficient de détermination R² supérieur à 0,90 sur les cadences journalières d'atelier."),
        bullet("**Intégrité, complétude et gouvernance des données** : le pipeline ETL doit assurer un taux de complétude de 100 % sur les séries d'atelier (imputation rigoureuse des valeurs aberrantes, suppression des stocks négatifs) et garantir une stricte traçabilité des accès aux données industrielles sensibles via le protocole RBAC."),
        bullet("**Interprétabilité et aide à la décision industrielle** : la restitution visuelle des indicateurs décisionnels (courbes de prévision avec bandes d'incertitude à 95 %, segmentation Pareto ABC, clustering K-Means et détection d'anomalies) doit être claire, explicable et directement exploitable pour le pilotage opérationnel d'atelier."),
        pb(),
        ...
        body("La structure des entités persistantes est représentée par le diagramme de classes global (figure 2.4). Il modélise les entités maîtresses : `Utilisateur`, `Role`, `Machine`, `OrdreProduction`, `ArretMachine`, `Article`, `MouvementStock` et `PredictionProphet`."),
        pb(),
        ...
        pb(),
        ...techCard(1, "Spring Boot 3 et Java 17", "logos/Spring Boot.png",
        ...
        ...techCard(2, "React 18 et TypeScript sous Metronic 8", "logos/react.png",
        ...
        makeTable(
          ...
          [
            ...
            ["US03", "En tant qu'administrateur, je veux auditer l'entrepôt de données", "Cartographie des 83 tables et métadonnées de volumétrie", "8 SP", "Terminé"],
            ["US04", "En tant qu'administrateur, je veux assainir les données de stock", "Implémentation du pipeline ETL et indexation clusterisée", "5 SP", "Terminé"],
          ],
        ...
        title2("3.4 Analyse Exploratoire des Données et Diagnostic Qualité"),
        ...
        title3("3.5.3 Stratégie d'Agrégation et d'Optimisation des Données Analytiques"),
        body("Pour alimenter efficacement les pipelines de modélisation prédictive et les tableaux de bord décisionnels sans saturer la base de données transactionnelle, une architecture d'agrégation et d'accélération analytique a été mise en œuvre :"),
        bullet("**Pré-agrégation temporelle des séries de fabrication** : Les écritures brutes d'atelier (volumes horaires, temps de cycle de presse, consommations de matière) sont consolidées et pré-agrégées à l'échelle journalière, constituant des matrices de données prêtes pour l'inférence des modèles de Machine Learning (Prophet, ARIMA, Isolation Forest)."),
        bullet("**Structuration et persistance des matrices en mémoire** : Les agrégats multidimensionnels fréquemment sollicités (indicateurs TRG/OEE par centre de charge, volumétrie des 319 machines, valorisation des stocks) sont maintenus dans une structure analytique optimisée en mémoire vive (RAM). Cette organisation supprime les opérations d'I/O disques répétitives et réduit la charge computationnelle du Data Warehouse."),
        bullet("**Accès analytique instantané (< 1 ms)** : Grâce à cette pré-structuration mémoire, les requêtes analytiques complexes et le chargement des séries temporelles sont servis instantanément (< 1 ms), assurant une réactivité totale pour l'exploration de données et la restitution graphique."),
        bullet("**Synchronisation incrémentale des flux** : Le mécanisme de synchronisation actualise les agrégats analytiques au fil de l'intégration des nouveaux mouvements de production, garantissant en permanence la fraîcheur des indicateurs industriels."),
        pb(),

        title3("3.5.4 Bilan Qualité des Données et Performances"),
        body("Le tableau 3.3 récapitule les gains qualitatifs et d'accélération analytique enregistrés après exécution du pipeline ETL et optimisation de l'accès aux données :"),
        pb(),
        makeTable(
          ["Indicateur Qualité / Performance", "État Initial (DWH Brut)", "État Après Optimisation Analytique", "Gain / Amélioration"],
          [
            ...
            ["Temps moyen d'extraction analytique (TOP 5000)", "31,4 secondes", "0,448 seconde (448 ms)", "Temps divisé par 70 (Indexation)"],
            ["Temps d'accès aux agrégats de séries en mémoire", "Plusieurs secondes", "< 1 ms", "Restitution instantanée des matrices"],
            ["Unicité et intégrité référentielle", "96,2 %", "100 % (Clés étrangères garanties)", "Fiabilisation intégrale"],
          ],
          [2800, 2100, 2100, 1666]
        ),
        new Paragraph({
          children: [new TextRun({ text: "Tableau 3.3 : Bilan qualité des données et performances avant et après optimisations", font: FONT, size: 20, italics: true, color: GRAY })],
          alignment: AlignmentType.CENTER,
          spacing: { before: 80, after: 120 },
        }),
        pb(),
        ...
        title2("3.7 Bilan des Livrables et Validation du Sprint 1"),
        body("S'agissant d'un projet de fin d'études appliqué en **Data Science & Business Intelligence**, la démarche de validation du Sprint 1 repose sur des critères stricts de **qualité des données**, d'**intégrité du schéma DWH assaini** (100% de complétude), de conformité du pipeline ETL et de validation de la gouvernance des données par le Product Owner."),
        pb(),
        body("Le tableau 3.4 formalise le bilan des livrables validés à l'issue du Sprint 1 :"),
        pb(),
        makeTable(
          ["Tâche Réalisée", "Livrable Associé", "Validation Métier & Data", "Statut"],
          [
            ["Audit du Data Warehouse", "Rapport de cartographie des 83 tables et volumétries", "Validé par le PO", "Terminé ✓"],
            ["Assainissement ETL", "Pipeline de nettoyage SQL et suppression des anomalies", "Validé sur données réelles", "Terminé ✓"],
            ["Optimisation des requêtes DWH", "Index clusterisé PK sur Entry No_ DESC dans FACT_ILE", "Validé (448 ms)", "Terminé ✓"],
            ["Agrégation analytique", "Pré-calcul des séries temporelles et accès optimisé en mémoire", "Validé (< 1 ms)", "Terminé ✓"],
            ["Gouvernance et sécurité d'accès", "Matrice RBAC et authentification JWT pour la protection des données", "Validé fonctionnellement", "Terminé ✓"],
            ["Console d'administration", "Interface de gestion des profils et droits d'accès aux données", "Validé par l'administrateur", "Terminé ✓"],
          ],
          [2200, 3200, 2000, 1266]
        ),
        new Paragraph({
          children: [new TextRun({ text: "Tableau 3.4 : Bilan des livrables et validation du Sprint 1", font: FONT, size: 20, italics: true, color: GRAY })],
          alignment: AlignmentType.CENTER,
          spacing: { before: 80, after: 120 },
        }),
        pb(),
        ...
        title3("4.6.3 Modèle Additif Prophet de Meta"),
        ...
        title3("4.6.4 Modèle Non Supervisé Isolation Forest"),
        ...
        pb(),
        body("Les figures 4.2 et 4.3 illustrent la comparaison visuelle des performances des 3 modèles sur les métriques clés (R², MAE, MAPE, RMSE) :"),
        pb(),
        ...imageFigure("diagrams/comparaison_modeles_r2_mae.png", "Figure 4.2 : Comparaison visuelle des modèles de prévision de production selon R² et MAE", 540, 230),
        pb(),
        body("L'analyse comparative des trois modèles intégrés dans l'application démontre :"),
        bullet("**Supériorité incontestable de Prophet (Meta)** : Avec un R² = 0,9600, Prophet explique **96 % de la variance journalière** de fabrication. Son erreur moyenne absolue (MAE) n'est que de **7,4 pièces par jour**, assurant une exactitude maximale pour le pilotage d'atelier."),
        bullet("**Atteinte du seuil d'excellence ($R^2 \ge 0,80$)** : Prophet (0,9600) et ARIMA (0,8100) dépassent le seuil cible industriel fixé à R² = 0,80, tandis que la Régression Linéaire (R² = 0,7200) reste limitée par son incapacité à modéliser la saisonnalité hebdomadaire des postes d'atelier."),
        ...
        pb(),
        title2("4.8 Sélection et Justification Multicritère du Modèle Champion Prophet"),
        ...
        new Paragraph({
          children: [new TextRun({ text: "Tableau 4.11 : Justification multicritère du choix de Prophet", font: FONT, size: 20, italics: true, color: GRAY })],
          alignment: AlignmentType.CENTER,
          spacing: { before: 80, after: 120 },
        }),
        pb(),
        ...
        title2("4.10 Bilan des Livrables et Validation Data Science du Sprint 2"),
        body("Dans le cadre de ce projet de Data Science, la validation algorithmique du modèle prédictif est régie par l'évaluation statistique rigoureuse sur le jeu de test chronologique (20 % de l'historique de fabrication non vu). Les métriques d'erreur obtenues (MAE = 7,4 pièces, MAPE = 4,8 %, R² = 0,9600) confirment la supériorité de Prophet et sa précision opérationnelle pour l'ordonnancement d'atelier."),
        pb(),
        ...
        makeTable(
          ["Tâche Réalisée", "Livrable Associé", "Validation Métier & Data", "Statut"],
          [
            ["Préparation des séries temporelles", "Pipeline d'extraction et transformation log sur l'historique de fabrication", "Validé par le Product Owner", "Terminé ✓"],
            ...
            ["Microservice FastAPI & Fallback", "API REST de production avec restitution ApexCharts et repli offline", "Validé fonctionnellement", "Terminé ✓"],
          ],
          [2200, 3200, 2000, 1266]
        ),
        new Paragraph({
          children: [new TextRun({ text: "Tableau 4.12 : Bilan des livrables et validation Data Science du Sprint 2", font: FONT, size: 20, italics: true, color: GRAY })],
          alignment: AlignmentType.CENTER,
          spacing: { before: 80, after: 120 },
        }),
        pb(),
        ...
        pb(),
        body("Ce module exploite les prévisions de fabrication générées par Prophet pour analyser en temps réel l'état de chaque référence du catalogue d'articles, détecter proactivement les situations à risque et produire des recommandations automatiques d'Ordres de Fabrication et d'approvisionnement matière."),
        pb(),
...
pb(),
        ...
        title3("5.6.4 Moteur Prescriptif du Point de Commande et Stock de Sécurité"),
        ...
        title3("5.7.4 Analyse Multi-Sites et Transferts Inter-Usines"),
        ...
        title2("5.8 Bilan des Livrables et Validation Métier du Sprint 3"),
        body("La validation du module de stock s'appuie sur des simulations d'approvisionnement réelles, le calcul de couverture sur 45 jours et l'arbitrage des transferts multi-sites, validés conjointement avec les gestionnaires de stock et les responsables d'atelier."),
        pb(),
        body("Le tableau 5.6 récapitule les livrables validés à l'issue du Sprint 3 :"),
        pb(),
        makeTable(
          ["Tâche Réalisée", "Livrable Associé", "Validation Métier & Logistique", "Statut"],
          [
        ...
        new Paragraph({
          children: [new TextRun({ text: "Tableau 5.6 : Bilan des livrables et validation du Sprint 3", font: FONT, size: 20, italics: true, color: GRAY })],
          alignment: AlignmentType.CENTER,
          spacing: { before: 80, after: 120 },
        }),
        pb(),
...
// CHAPITRE 6 : SPRINT 4 – DASHBOARDS & VALIDATION
        ...
        title2("6.4 Conception et Réalisation des Interfaces Utilisateur"),
        ...
        makeTable(
          ...
          [
            ...
            ["Complexité d'analyse des métriques pour le management", "Frein à l'adoption des modèles prédictifs", "Conception d'une interface décisionnelle visuelle unifiée avec indicateurs synthétiques et dialogue en langage naturel."],
          ],
          [2400, 1800, 4466]
        ),
        new Paragraph({
